...
if (process.env.NODE_ENV == 'development') {
    axios.defaults.baseURL = API_URL || "http://manage-api.ministudy.com"; // http://ssh.trytv.org:8778
    // axios.defaults.baseURL = "http://manage-api-toutiao.ministudy.com";
} else if (process.env.NODE_ENV == 'debug') {
    axios.defaults.baseURL = '';
} else if (process.env.NODE_ENV == 'production') {
    axios.defaults.baseURL = API_URL || "http://manage-api.ministudy.com"; //http://manage-api.ministudy.com
    // axios.defaults.baseURL = "http://manage-api-toutiao.ministudy.com";
}
