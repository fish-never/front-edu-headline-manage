<template>
  <div>
    <p class="location"><router-link to="/index/operationStorage" class="grey">运营池</router-link>>视频文章预览</p>
    <div class="wrap">
      <div class="item">
        <el-form  label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="封面:" prop="coverage">
            <p class="img-item">
              <img :src="data.coverage" width="45" height="29" />
            </p>
          </el-form-item >
            <el-form-item  prop="content" class="item-content-wrap">
